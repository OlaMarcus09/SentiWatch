            ...
            {showProfile && (
              ...
              >
                <div className="p-4 border-b border-slate-100 dark:border-slate-700">
                  <p className="text-sm font-medium text-slate-800 dark:text-slate-200">Marcus Olawale</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400">marcus@sentiwatch.com</p>
                </div>
                <div className="p-2">
